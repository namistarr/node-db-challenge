...
A: A relational database stores data in tables, SQL is a query language that interacts with the data and provides different ways to organize/view it.

- [ ] Why do tables need a `primary key`?
A: A primary key gives each entry a unique identifier (ID).

- [ ] What is the name given to a table column that references the primary key on another table.
A: Foreign key.

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
A: A third table with foreign keys that link them. 
